...
RUN apt-get install -y --no-install-recommends \
    curl nodejs wget unzip vim git git-lfs jq build-essential clang xorg-dev libglu1-mesa-dev libssl-dev libffi-dev python3 python3-venv python3-dev python3-pip
